...
def get_args_parser(subparsers):
    ...
    # G-Prompt parameters
    subparsers.add_argument('--use_g_prompt', default=0, type=int, help='if using G-Prompt')
    ...
    subparsers.add_argument('--use_prefix_tune_for_g_prompt', default=0, type=int,
                            help='if using the prefix tune for G-Prompt')

    # E-Prompt parameters
    subparsers.add_argument('--use_e_prompt', default=1, type=int, help='if using the E-Prompt')
    subparsers.add_argument('--e_prompt_layer_idx', default=[0, 1, 2, 3, 4], type=int, nargs="+",
                            help='the layer index of the E-Prompt')
    subparsers.add_argument('--use_prefix_tune_for_e_prompt', default=1, type=int,
    ...
    subparsers.add_argument('--reg', default=0.0, type=float)
    ...
    # CAPrompt Parameters
    subparsers.add_argument('--trained_caprompt_model', type=str, default='', help='Trained CAPrompt Model for Evaluation')
    subparsers.add_argument('--ckpt_num', type=int, default=0, help='Task of Trained CAPrompt Model')
    subparsers.add_argument('--penalty_weight', type=float, default=0, help='Weight of Linear Constrain')
    subparsers.add_argument('--delta_weight', type=float, default=1.0, help='Weight of Concave Constrain')
    subparsers.add_argument('--cycle_num', type=int, default=3, help='number of cycle')
